...
verificadoPor: "Pasos generalizados a partir de una guía de El País (Cali) y confirmados de forma independiente por Vanguardia — el proceso en sí (reporte → censo/RUD → valoración técnica → documentación) es consistente entre ambas fuentes, aunque el canal exacto de reporte cambia según tu municipio. El 14 de agosto se agregaron los datos de contacto de la UNGRD (línea gratuita 01-8000-113200 y correos) tomados directamente del portal de la propia entidad — ese bloque sí está confirmado contra la fuente oficial; los pasos del RUD todavía no, por eso la entrada completa sigue marcada como sin verificar."
fechaVerificacion: 2026-08-14
orden: 1
pasos:
...
Cada departamento afectado tiene su propio consejo — revisa la
[página de tu región](/wiki/) para el canal local.
